...
const getStartOfWeek = (date: Date) => {
  ...
  const day = d.getDay();
  const diff = d.getDate() - day + (day === 0 ? -6 : 1); // Semana começa na Segunda-feira
...
export default function Schedule() {
  ...
  const weeklyAppointments = useMemo(() => {
    ...
    const filtered = appointments.filter(appointment => {
      ...
      if (!matchesDateRange || !matchesStatus) return false;
    ...
    return groupedByDay;
  }, [appointments, clients, currentDate, filterStatus, searchTerm]);
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 mb-6">
        <div className="flex flex-col md:flex-row gap-4">
          ...
          <div className="flex items-center space-x-2 flex-1">
            ...
            <input type="text" placeholder="Buscar por cliente ou telefone..." value={searchTerm} onChange={(e) => setSearchTerm(e.target.value)} className="flex-1 px-3 py-2 border border-gray-300 rounded-lg" />
          </div>
          <div className="flex items-center space-x-2">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <select name="profissional_id" required value={formData.profissional_id} onChange={handleFormChange} className="w-full px-4 py-2 border border-gray-300 rounded-lg">
